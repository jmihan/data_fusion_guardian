...
Читает фичи из cache/ (тот же каталог, что и run_catboost.py), v5_config.json.
Присоединяет CoLES эмбеддинги, рефитит 4 модели по 3 сидам, создает файл сабмита.
"""
import gc, time, warnings, functools, json
...
from src.sol154.config import (
    SOL154_SOLUTION1_CACHE as CACHE_DIR,
    SOL154_COLES_CACHE as CACHE_COLES,
    DATA_DIR,
    SOL154_SOLUTION1_SUBMISSIONS as SUBMISSIONS,
)
